                ...
                ">
                    <img 
                        ...
                        style="
                            ...
                            object-fit: cover;
                        "
                        onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22140%22 height=%22140%22%3E%3Crect fill=%22%236c5ce7%22 width=%22140%22 height=%22140%22/%3E%3Ctext x=%2270%22 y=%2285%22 font-size=%2260%22 text-anchor=%22middle%22%3E🎵%3C/text%3E%3C/svg%3E'"
                    />
                </div>
            </div>
    ...
    useEffect(() => {
        ...
        overlay.innerHTML = `
            ...
            <div style="
                ...
                overflow: hidden;
                box-shadow: 
                    0 10px 40px rgba(108, 92, 231, 0.5),
            ...
            ">
                <img 
                    ...
                    style="
                        ...
                        object-fit: cover;
                    "
                    onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22120%22 height=%22120%22%3E%3Crect fill=%22%236c5ce7%22 width=%22120%22 height=%22120%22/%3E%3Ctext x=%2260%22 y=%2270%22 font-size=%2250%22 text-anchor=%22middle%22%3E🎵%3C/text%3E%3C/svg%3E'"
                />
                ...
                <div style="
                    ...
                    right: -3px;
                    bottom: -3px;
                    background: conic-gradient(from 0deg, #6c5ce7, #a855f7, #6c5ce7);
                    border-radius: 20px;
                    z-index: -1;
                    animation: rotateBorder 3s linear infinite;
                "></div>
            ...
            <!-- SPARKLE PARTICLES - LARGE & VERY VISIBLE -->
            <div style="
                position: absolute;
                top: 15%;
                left: 8%;
                ...
                box-shadow: 0 0 25px #fbbf24, 0 0 40px #fbbf24;
                z-index: 5;
            ">
                <div style="
                    position: absolute;
            ...
            <div style="
                ...
                box-shadow: 0 0 25px #ec4899, 0 0 40px #ec4899;
                z-index: 5;
            ">
                <div style="
                    position: absolute;
            ...
            <div style="
                ...
                border-radius: 50%;
                animation: sparkleFloat 2.8s ease-in-out infinite 0.8s;
            ...
            <div style="
                ...
                border-radius: 50%;
                animation: sparkleFloat 3.2s ease-in-out infinite 1.5s;
            ...
            <div style="
                ...
                border-radius: 50%;
                animation: sparkleFloat 2.7s ease-in-out infinite 0.3s;
                box-shadow: 0 0 25px #f97316, 0 0 40px #f97316;
                z-index: 5;
            ">
                <div style="
                    position: absolute;
        ...
        style.textContent = `
            ...
            @keyframes sparkleFloat {
                ...
                75% {
                    opacity: 1;
                    transform: translateY(-15px) scale(1.3) rotate(270deg);
                }
            }
        `;
